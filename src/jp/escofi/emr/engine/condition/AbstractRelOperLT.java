 ...
 * @author EBS
 */
public abstract class AbstractRelOperLT extends AbstractSingleCondition {

	/**
	 * コンストラクタ。
	 * @param items  本演算子のオペランドリスト
	 */
	public AbstractRelOperLT(List<AbstractOperand> items) {
		super(items);
	}
	...
	public void toDump(XMLWriter writer,
			...
			throws SAXException {
		writer.startElement(ElementType.LT.toString());
		...
		writer.endElement(ElementType.LT.toString());
	}
}
