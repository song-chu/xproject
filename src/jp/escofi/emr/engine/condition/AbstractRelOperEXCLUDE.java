 ...
 * @author EBS
 */
public abstract class AbstractRelOperEXCLUDE extends AbstractSingleCondition {
	/**
	 * 下限の境界値を含むか(true:含む)
	 */
	 ...
	 *            本演算子のオペランドリスト
	 */
	public AbstractRelOperEXCLUDE(List<AbstractOperand> items) {
		super(items);
	}
	...
	public void toDump(XMLWriter writer,
		...
		writer.startElement(ElementType.EXCLUDE.toString(), atts);
		...
		writer.endElement(ElementType.EXCLUDE.toString());
	}
