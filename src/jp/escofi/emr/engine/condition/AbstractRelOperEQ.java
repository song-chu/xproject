 ...
 * @author EBS
 */
public abstract class AbstractRelOperEQ extends AbstractSingleCondition {
	 ...
	 *            本演算子のオペランドList
	 */
	public AbstractRelOperEQ(List<AbstractOperand> items) {
		super(items);
	}
	...
	public void toDump(XMLWriter writer,
			...
			throws SAXException {
		writer.startElement(ElementType.EQ.toString());
		...
		writer.endElement(ElementType.EQ.toString());
	}
}
