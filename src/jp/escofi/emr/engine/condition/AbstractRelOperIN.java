 ...
 * @author EBS
 */
public abstract class AbstractRelOperIN extends AbstractSingleCondition {
	 ...
	 *            本演算子のオペランドリスト
	 */
	public AbstractRelOperIN(List<AbstractOperand> items) {
		super(items);
	}
	...
	public void toDump(XMLWriter writer,
			...
			throws SAXException {
		writer.startElement(ElementType.IN.toString());
		...
		writer.endElement(ElementType.IN.toString());
	}
}
