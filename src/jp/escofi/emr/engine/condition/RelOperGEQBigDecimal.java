 ...
 * @author EBS
 */
public final class RelOperGEQBigDecimal extends AbstractRelOperGEQ {

	/**
	 * コンストラクタ
	 * @param items	本演算子のオペランドリスト
	 */
	public RelOperGEQBigDecimal(List<AbstractOperand> items) {
		super(items);
	}

	/**
	 * 左右オペランドのGEQ演算を行う。BigDecimal.compareTo()を利用する。
