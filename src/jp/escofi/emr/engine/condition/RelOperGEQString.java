 ...
 * @author EBS
 */
public final class RelOperGEQString extends AbstractRelOperGEQ {

	/**
	 * コンストラクタ
	 * @param items	本演算子のオペランドリスト
	 */
	public RelOperGEQString(List<AbstractOperand> items) {
		super(items);
	}

	/**
	 * 左右オペランドのGEQ演算を行う。String.compareTo()を利用する。
