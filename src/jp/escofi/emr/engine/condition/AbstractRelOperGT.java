 ...
 * @author EBS
 */
public abstract class AbstractRelOperGT extends AbstractSingleCondition {
	/**
	 ...
	 *            本演算子のオペランドリスト
	 */
	public AbstractRelOperGT(List<AbstractOperand> items) {
		super(items);
	}
	...
	public void toDump(XMLWriter writer,
			...
			throws SAXException {
		writer.startElement(ElementType.GT.toString());
		...
		writer.endElement(ElementType.GT.toString());
	}
}
