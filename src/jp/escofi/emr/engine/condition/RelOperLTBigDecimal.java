 ...
 * @author EBS
 */
public final class RelOperLTBigDecimal extends AbstractRelOperLT {

	/**
	 * コンストラクタ
	 * @param items	本演算子のオペランドリスト
	 */
	public RelOperLTBigDecimal(List<AbstractOperand> items) {
		super(items);
	}

	/**
	 * 左右オペランドのLT演算を行う。BigDecimal.compareTo()を利用する。
