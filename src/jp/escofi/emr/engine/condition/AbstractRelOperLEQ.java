 ...
 * @author EBS
 */
public abstract class AbstractRelOperLEQ extends AbstractSingleCondition {

	/**
	 * コンストラクタ。
	 * @param items  本演算子のオペランドリスト
	 */
	public AbstractRelOperLEQ(List<AbstractOperand> items) {
		super(items);
	}
	...
	public void toDump(XMLWriter writer,
			...
			throws SAXException {
		writer.startElement(ElementType.LEQ.toString());
		...
		writer.endElement(ElementType.LEQ.toString());
	}
}
