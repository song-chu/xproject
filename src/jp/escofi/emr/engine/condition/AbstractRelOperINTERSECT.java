 ...
 * @author EBS
 */
public abstract class AbstractRelOperINTERSECT extends AbstractSingleCondition {
	 ...
	 *            本演算子のオペランドリスト
	 */
	public AbstractRelOperINTERSECT(List<AbstractOperand> items) {
		super(items);
	}

	/**
	 * 関係演算INTERSECTの条件式を書き出す。
	 *
	 * @param writer ライター
	...
	public void toDump(XMLWriter writer,
			...
			throws SAXException {
		writer.startElement(ElementType.INTERSECT.toString());
		...
		writer.endElement(ElementType.INTERSECT.toString());
	}
}
