 ...
 * @author EBS
 */
public abstract class AbstractRelOperNOTIN extends AbstractSingleCondition {

	/**
	 * コンストラクタ。
	 * @param items  本演算子のオペランドリスト
	 */
	public AbstractRelOperNOTIN(List<AbstractOperand> items) {
		super(items);
	}
	...
	public void toDump(XMLWriter writer,
			...
			throws SAXException {
		writer.startElement(ElementType.NOT_IN.toString());
		...
		writer.endElement(ElementType.NOT_IN.toString());
	}
