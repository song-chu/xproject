 ...
 * @see jp.iwin.pds.datamodel.condition.PCOARelOperLEQ
 * @version 1.0
 * @since 1.0
 * @author $Author: park.js $
 */
public final class PCORelOperLEQBigDecimal extends PCOARelOperLEQ {

	/**
	 * コンストラクタ
	 * @param items	本演算子のオペランドリスト
	 */
	public PCORelOperLEQBigDecimal(List<PCOAOperand> items) {
		super(items);
	}

	/**
	 * 左右オペランドのLEQ演算を行う。BigDecimal.compareTo()を利用する。
