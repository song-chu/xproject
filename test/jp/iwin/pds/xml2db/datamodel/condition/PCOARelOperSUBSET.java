 ...
 */
public abstract class PCOARelOperSUBSET extends PCOASingleCondition {

	/**
	 * コンストラクタ。
	 * @param items  本演算子のオペランドリスト
	 */
	public PCOARelOperSUBSET(List<PCOAOperand> items) {
		super(items);
	}
	...
	public void toDump(PUTXMLWriter writer,
			...
			throws SAXException {
		writer.startElement(PCTElementType.SUBSET.toString());
		...
		writer.endElement(PCTElementType.SUBSET.toString());
	}
