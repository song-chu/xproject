 ...
 */
public final class PCORelOperLEQInteger extends PCOARelOperLEQ {

	/**
	 * コンストラクタ
	 * @param items	本演算子のオペランドリスト
	 */
	public PCORelOperLEQInteger(List<PCOAOperand> items) {
		super(items);
	}

	/**
	 * 左右オペランドのLEQ演算を行う。Integer.compareTo()を利用する。
