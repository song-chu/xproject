 ...
 */
public abstract class PCOARelOperNOTSUBSET extends PCOASingleCondition {

	/**
	 * コンストラクタ。
	 * @param items  本演算子のオペランドリスト
	 */
	public PCOARelOperNOTSUBSET(List<PCOAOperand> items) {
		super(items);
	}
	...
	public void toDump(PUTXMLWriter writer,
			...
			throws SAXException {
		writer.startElement(PCTElementType.NOTSUBSET.toString());
		...
		writer.endElement(PCTElementType.NOTSUBSET.toString());
	}
