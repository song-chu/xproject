 ...
 */
public final class PCORelOperINTERSECTObject extends PCOARelOperINTERSECT {

	/**
	 * コンストラクタ
	 * @param items	本演算子のオペランドリスト
	 */
	public PCORelOperINTERSECTObject(List<PCOAOperand> items) {
		super(items);
	}

	/**
	 * 左右オペランド（SET）のINTERSECT演算を行う。共通要素が一つ以上存在する場合TRUEを返す。
