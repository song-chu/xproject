 ...
 * @see jp.iwin.pds.datamodel.condition.PCOARelOperINCLUDE
 * @version 1.0
 * @since 1.0
 * @author $Author: park.js $
 */
public final class PCORelOperINCLUDEInteger extends PCOARelOperINCLUDE {

	/**
	 * コンストラクタ
	 * @param items	本演算子のオペランドリスト
	 */
	public PCORelOperINCLUDEInteger(List<PCOAOperand> items) {
		super(items);
	}
