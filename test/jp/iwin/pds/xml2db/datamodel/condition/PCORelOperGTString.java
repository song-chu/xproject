 ...
 */
public final class PCORelOperGTString extends PCOARelOperGT {

	/**
	 * コンストラクタ
	 * @param items	本演算子のオペランドリスト
	 */
	public PCORelOperGTString(List<PCOAOperand> items) {
		super(items);
	}

	/**
	 * 左右オペランド（String）のGT演算を行う。String.compareTo()を利用する。
