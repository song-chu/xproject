 ...
 */
public abstract class PCOARelOperINTERSECT extends PCOASingleCondition {
	 ...
	 *            本演算子のオペランドリスト
	 */
	public PCOARelOperINTERSECT(List<PCOAOperand> items) {
		super(items);
	}
	...
	public void toDump(PUTXMLWriter writer,
			...
			throws SAXException {
		writer.startElement(PCTElementType.INTERSECT.toString());
		...
		writer.endElement(PCTElementType.INTERSECT.toString());
	}
}
