 ...
 */
public abstract class PCOARelOperLEQ extends PCOASingleCondition {

	/**
	 * コンストラクタ。
	 * @param items  本演算子のオペランドリスト
	 */
	public PCOARelOperLEQ(List<PCOAOperand> items) {
		super(items);
	}
	...
	public void toDump(PUTXMLWriter writer,
			...
			throws SAXException {
		writer.startElement(PCTElementType.LEQ.toString());
		...
		writer.endElement(PCTElementType.LEQ.toString());
	}
}
