 ...
 */
public abstract class PCOARelOperGT extends PCOASingleCondition {
	/**
	 ...
	 *            本演算子のオペランドリスト
	 */
	public PCOARelOperGT(List<PCOAOperand> items) {
		super(items);
	}
	...
	public void toDump(PUTXMLWriter writer,
			...
			throws SAXException {
		writer.startElement(PCTElementType.GT.toString());
		...
		writer.endElement(PCTElementType.GT.toString());
	}
}
