 ...
 */
public abstract class PCOARelOperGEQ extends PCOASingleCondition {
	 ...
	 *            本演算子のオペランドリスト
	 */
	public PCOARelOperGEQ(List<PCOAOperand> items) {
		super(items);
	}
	...
	public void toDump(PUTXMLWriter writer,
			...
			throws SAXException {
		writer.startElement(PCTElementType.GEQ.toString());
		...
		writer.endElement(PCTElementType.GEQ.toString());
	}
}
