 ...
 */
public abstract class PCOARelOperINCLUDE extends PCOASingleCondition {
	/**
	 * 下限の境界値を含むか(true:含む)
	 */
	 ...
	 *            本演算子のオペランドリスト
	 */
	public PCOARelOperINCLUDE(List<PCOAOperand> items) {
		super(items);
	}
	...
	public void toDump(PUTXMLWriter writer,
		...
		writer.startElement(PCTElementType.INCLUDE.toString(), atts);
		...
		writer.endElement(PCTElementType.INCLUDE.toString());
	}
