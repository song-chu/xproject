 ...
 */
public final class PCORelOperINCLUDEDouble extends PCOARelOperINCLUDE {

	/**
	 * コンストラクタ
	 * @param items	本演算子のオペランドリスト
	 */
	public PCORelOperINCLUDEDouble(List<PCOAOperand> items) {
		super(items);
	}

	/**
	 * 左中右オペランド(Double)のINCLUDE演算を行う。Double.compareTo()を利用する。<br>
