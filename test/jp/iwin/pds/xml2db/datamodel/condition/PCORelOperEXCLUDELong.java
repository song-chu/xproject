 ...
 */
public final class PCORelOperEXCLUDELong extends PCOARelOperEXCLUDE {

	/**
	 * コンストラクタ
	 * @param items	本演算子のオペランドリスト
	 */
	public PCORelOperEXCLUDELong(List<PCOAOperand> items) {
		super(items);
	}

	/**
	 * 左中右オペランド(Long)のEXCLUDE演算を行う。Long.compareTo()を利用する。<br>
