 ...
 * @see jp.iwin.pds.datamodel.condition.PCOARelOperGT
 * @version 1.0
 * @since 1.0
 * @author $Author: park.js $
 */
public final class PCORelOperGTInteger extends PCOARelOperGT {

	/**
	 * コンストラクタ
	 * @param items	本演算子のオペランドリスト
	 */
	public PCORelOperGTInteger(List<PCOAOperand> items) {
		super(items);
	}

	/**
	 * 左右オペランド（Integer）のGT演算を行う。Integer.compareTo()を利用する。
