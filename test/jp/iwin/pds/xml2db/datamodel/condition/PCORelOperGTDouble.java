 ...
 */
public final class PCORelOperGTDouble extends PCOARelOperGT {

	/**
	 * コンストラクタ
	 * @param items	本演算子のオペランドリスト
	 */
	public PCORelOperGTDouble(List<PCOAOperand> items) {
		super(items);
	}

	/**
	 * 左右オペランド（Double）のGT演算を行う。Double.compareTo()を利用する。
