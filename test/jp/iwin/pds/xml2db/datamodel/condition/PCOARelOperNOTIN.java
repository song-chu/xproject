 ...
 */
public abstract class PCOARelOperNOTIN extends PCOASingleCondition {

	/**
	 * コンストラクタ。
	 * @param items  本演算子のオペランドリスト
	 */
	public PCOARelOperNOTIN(List<PCOAOperand> items) {
		super(items);
	}
	...
	public void toDump(PUTXMLWriter writer,
			...
			throws SAXException {
		writer.startElement(PCTElementType.NOTIN.toString());
		...
		writer.endElement(PCTElementType.NOTIN.toString());
	}
