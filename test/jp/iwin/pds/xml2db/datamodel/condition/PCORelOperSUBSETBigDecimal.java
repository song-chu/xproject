 ...
 * @see jp.iwin.pds.datamodel.condition.PCOARelOperSUBSET
 * @version 1.0
 * @since 1.0
 * @author $Author: park.js $
 */
public final class PCORelOperSUBSETBigDecimal extends PCOARelOperSUBSET {

	/**
	 * コンストラクタ
	 * @param items	本演算子のオペランドリスト
	 */
	public PCORelOperSUBSETBigDecimal(List<PCOAOperand> items) {
		super(items);
	}

	/**
	 * 左右オペランド（BigDecimalのSET）のSUBSET演算を行う。集合左オペランドが集合右オペランドの部分集合である場合TRUEを返す。
