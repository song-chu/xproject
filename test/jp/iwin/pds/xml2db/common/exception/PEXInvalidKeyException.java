...
public class PEXInvalidKeyException extends PEXException {
	 ...
	 */
	public PEXInvalidKeyException(PCTMessageCode errCode) {
		super(errCode);
	}
	 ...
	 */
	public PEXInvalidKeyException(PCTMessageCode errCode, Object[] arguments) {
	 ...
	 * @param cause 原因例外
	 */
	public PEXInvalidKeyException(PCTMessageCode errCode, Throwable cause) {
		super(errCode, cause);
	}
}
